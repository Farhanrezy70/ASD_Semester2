...
import Jobsheet_12.Tugas1.Faksinasi19;
        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    Film19 nb = new Film19(id, judul, rating);
                    dll.addFirst(nb);
                    System.out.println();
                    break;
                case 2:
                    ...
                    Film19 nb1 = new Film19(id1, judul1, rating1);
                    dll.addFirst(nb1);
                    System.out.println();
                    break;
                case 3:
                    ...
                    Film19 nb2 = new Film19(id2, judul2, rating2);
                    dll.add(nb2, index);
                    System.out.println();
                    break;
                case 4:
                    Film19 film = dll.getFirst();
                    System.out.println("Film " +film.judul + " telah dihapus.");
                    dll.removeFirst();
                    System.out.println();
                    break;
                case 5:
                    Film19 film1 = dll.getLast();
                ...
                case 8:
                    ...
                    Film19 seach = dll.searchById(idSearch);
