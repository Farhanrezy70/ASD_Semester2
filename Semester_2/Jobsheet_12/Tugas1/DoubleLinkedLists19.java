...
public class DoubleLinkedLists19 {
    ...
    public void addFirst(Faksinasi19 item) {
        if (isEmpty()) {
    ...
    public void addlast(Faksinasi19 item) {
        if (isEmpty()) {
            addFirst(item);
        } else {
            Node19 current = head;
    ...
    public void add(Faksinasi19 item, int index) throws Exception {
        if (isEmpty()) {
            addFirst(item);
    ...
    public Faksinasi19 getFirst() throws Exception {
        if (isEmpty()) {
    ...
    public Faksinasi19 getLast() throws Exception {
        if (isEmpty()) {
            throw new Exception("Linked List kosong");
        }
        Node19 tmp = head;
    ...
    public Faksinasi19 get(int index) throws Exception {
        if (isEmpty() || index >= size) {
            throw new Exception("Nilai indeks di luar batas.");
        }
        Node19 tmp = head;
